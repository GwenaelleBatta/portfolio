	...
	<section aria-labelledby="intro" class="layout__intro intro slide-in">
		...
		<div class="intro__container ">
			...
			<a href="<?= get_the_permalink(portfolio_get_template_page('template-contact')) ?>"
			   class="intro__link"><?= __('Me contacter', 'portfolio') ?></a>
		</div>
	</section>
	<section aria-labelledby="projects" class="layout__project projects">
		<div class="projects__header latest">
			<h2 id="projects" class="projects__latest" aria-level="2"><?= __('Mes derniers projets', 'portfolio') ?></h2>
